...
// ── NAV ─────────────────────────────────────────────────────────
// APP_VERSION sadece ekranda gösterilen versiyon rozeti ("v0.6.8") ve
// erişilebilirlik etiketi için kullanılıyor — indirme linki artık buna
// bağlı değil (aşağıya bak), ama bu sabit silinirse sayfanın başka
// yerlerinde "APP_VERSION tanımsız" hatasıyla beyaz ekran oluşur.
const APP_VERSION = "0.6.8";

// Not: İndirme linki artık sabit bir versiyon numarasına gömülü exe
// dosya adı kullanmıyor — her yeni release'de versiyon değişince kod
// güncellenmezse link 404 veriyordu. Bunun yerine GitHub'ın "latest"
// release sayfasına yönlendiriyoruz; bu link hangi versiyon
